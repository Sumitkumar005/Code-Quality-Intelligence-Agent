// Projects Service - Final Corrected Version
...
export class ProjectsService {
  ...
  async exportProject(projectId: string, format: 'json' | 'yaml' | 'zip' = 'json'): Promise<ApiResponse<any>> {
    return apiClient.get<any>(`/api/v1/projects/${projectId}/export?format=${format}`)
  }
